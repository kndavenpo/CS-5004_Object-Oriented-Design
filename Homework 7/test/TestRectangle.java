...
public class TestRectangle {
  ...
  public void testToString() {
    rectangle1.setName("R1");
    assertEquals("Name: R1\nType: rectangle\nMin corner: (100, 200), Width: 25.0, "
            + "Height: 200.0, Color: (0, 200, 75)", rectangle1.toString());

    rectangle2.setName("R2");
    assertEquals("Name: R2\nType: rectangle\nMin corner: (300, 75), Width: 200.0, "
            + "Height: 400.0, Color: (75, 25, 250)", rectangle2.toString());
  }
