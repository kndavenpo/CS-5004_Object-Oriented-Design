...
public class TestOval {
  ...
  public void testResize() {
    ...
    assertEquals(300, oval1.getWidth(), 0.001);
  ...
  public void testToString() {
    oval1.setName("Oval1");
    assertEquals("Name: Oval1\nType: oval\nCenter: (1, 150), Width: 10.0, "
            + "Height: 599.0, Color: (0, 0, 255)", oval1.toString());

    oval2.setName("Oval2");
    assertEquals("Name: Oval2\nType: oval\nCenter: (250, 599), Width: 999.0, "
            + "Height: 150.0, Color: (0, 255, 0)", oval2.toString());
  }
