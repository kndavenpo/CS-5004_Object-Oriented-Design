 ...
 *  CS 5004 - Lab 4
 *
 *  <p>This is the abstract superclass of all Artist concrete classes. It implements the
...
public abstract class AbstractArtist implements IArtist {
   ...
   * @return (String)
   */
  public String getGenresAsSingleString() {
  ...
  /**
   * Override of the toString() method that answers the basic information held by the
   * AbstractArtist.
   *
   * @return (String)
   */
